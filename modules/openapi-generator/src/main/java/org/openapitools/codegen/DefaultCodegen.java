	...
	protected void handleMethodResponse(Operation operation,
		...
		if (responseSchema != null) {
			...
			if (!isSkipOperationExample()) {
				...
				op.examples = new ArrayList<>();//new ExampleGenerator(schemas, this.openAPI).generateFromResponseSchema(exampleStatusCode, responseSchema, getProducesInfo(this.openAPI, operation));
			}
